...
def print_info(text: str, print_in_report: bool = True, underline: bool = False):
    ...
    __print(category=1, color=color, print_in_report=print_in_report, underline=underline, log_type="INFO", date=now,
...
def print_error(text: str, print_in_report: bool = True, underline: bool = False):
    ...
    color = RED
    data = inspect.stack()[1]
    __print(category=1, color=color, print_in_report=print_in_report, underline=underline, log_type="ERROR", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def print_warning(text: str, print_in_report: bool = True, underline: bool = False):
    ...
    color = YELLOW
    data = inspect.stack()[1]
    __print(category=1, color=color, print_in_report=print_in_report, underline=underline, log_type="WARNING", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def print_debug(text: str, print_in_report: bool = False, underline: bool = False):
    ...
    color = WHITE
    data = inspect.stack()[1]
    __print(category=1, color=color, print_in_report=print_in_report, underline=underline, log_type="DEBUG", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def robot_print_info(text: str, print_in_report: bool = True, underline: bool = False):
    ...
    color = GREEN
    data = inspect.stack()[1]
    __print(category=2, color=color, print_in_report=print_in_report, underline=underline, log_type="INFO", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def robot_print_debug(text: str, print_in_report: bool = False, underline: bool = False):
    ...
    color = WHITE
    data = inspect.stack()[1]
    __print(category=2, color=color, print_in_report=print_in_report, underline=underline, log_type="DEBUG", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def robot_print_warning(text: str, print_in_report: bool = True, underline: bool = False):
    ...
    color = YELLOW
    data = inspect.stack()[1]
    __print(category=2, color=color, print_in_report=print_in_report, underline=underline, log_type="WARNING", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def robot_print_error(text: str, print_in_report: bool = True, underline: bool = False):
    ...
    color = RED
    data = inspect.stack()[1]
    __print(category=2, color=color, print_in_report=print_in_report, underline=underline, log_type="ERROR", date=now,
            text=text, class_name=data[1], function=data[3], line_number=data[2])
...
def robot_custom_print(text: str, color: str, print_in_report: bool = False, underline: bool = False,
    ...
    if set_class_info:
        ...
        function = None
        line_number = None
    __print(category=2, color=color, print_in_report=print_in_report, underline=underline, log_type="",
