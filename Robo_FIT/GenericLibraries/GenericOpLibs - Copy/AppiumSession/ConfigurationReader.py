...
class ConfiguratorReader:
    ...
    def __init__(self):
        ...
        'Robo_FIT/GenericLibraries/GenericOpLibs/AppiumSession/appium_config_file.json' path.
        """
        try:
            self.common_keyword = CommonKeywordsClass()
            robot_print_debug(f"Appium config reader path: {self.common_keyword.team_name}")
            ...
            if os.path.isfile(self.config_path):
                ...
                default_config_path = os.path.join(self.common_keyword.get_root_path(), ROBO_FIT, APPIUM_SESSION,
                                                   APPIUM_CONFIG)
