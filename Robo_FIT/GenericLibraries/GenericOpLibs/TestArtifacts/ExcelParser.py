...
class ExcelParser:
    ...
    def get_cell_value(self, unique_key: str, unique_key_column_name: str, get_value_from_column: str) -> str:
        ...
        :param unique_key: element to be searched in column, e.g. VOICE_RECOGNITION_PLAY_SONG, VOICE_RECOGNITION_STOP
    ...
    def write_to_cell(self, unique_key: str, unique_key_column_name: str, value_to_set: str, write_to_column: str):
        ...
        :param unique_key: command to be searched in column, e.g. VOICE_RECOGNITION_PLAY_SONG, VOICE_RECOGNITION_STOP etc.
