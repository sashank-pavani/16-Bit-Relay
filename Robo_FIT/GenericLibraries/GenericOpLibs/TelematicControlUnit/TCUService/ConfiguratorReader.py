...
class ConfiguratorReader:
    ...
    def __init__(self):
        ...
        'Robo_FIT/GenericLibraries/GenericOpLibs/TelematicControlUnit/tcu_config_file.json' path.
        """
        try:
            ...
            if os.path.isfile(self.config_path):
                ...
                default_config_path = os.path.join(self.common_keyword.get_root_path(), ROBO_FIT, TCU_UNIT_MODULE,
                                                   TCU_CONFIG)
