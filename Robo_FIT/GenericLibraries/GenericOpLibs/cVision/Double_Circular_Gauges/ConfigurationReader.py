...
class ConfigurationReader:
        ...
        if ConfigurationReader.__instance is not None:
            ...
            try:
                ...
                config_path = os.path.join(self.common_keyword.get_root_path(), PROJECT,
                                           CRE_LIBRARIES,"ProjectLibs","cVision","Double_Circular_Gauges", "Double_Circular_Gauges_Config_File.json")
                j=open(config_path)
                data = json.load(j)
    ...
    def read_list(self, key: str) -> list:
        ...
        :param key: The key to read from the configuration (e.g., "ref_img_bar1.boundary_line_color").
